...
/***/ "./resources/js/forecourt/landing_page.js":
/*!************************************************!*\
  !*** ./resources/js/forecourt/landing_page.js ***!
  \************************************************/
/*! no exports provided */
...
var methods = (_methods = {
  initMapSection: function initMapSection() {
  ...
  getMapData: function getMapData(date, goodsId) {
    ...
    axios.post(_data.routeGetMapData, {
      ...
      elMapAvgValue.innerHTML = "Rp. ".concat(res.data.avgPrice);
    });
  },
  drawMap: function drawMap(data) {
    return _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
      var elMapSection, elMapLegend, loader, options;
    ...
    options.data.features.forEach(function (feature) {
      if (feature.geometry.coordinates.length > 0) {
        ...
        mapsApi.event.addListener(area, "mouseover", function (e) {
          ...
          price.innerHTML = feature.properties.price > 0 ? "Rp. ".concat(feature.properties.price) : 'Belum ada data';
        ...
        mapsApi.event.addListener(area, "mousemove", function (e) {
          var infoBox = document.getElementById('map-info-box');
          var left = e.domEvent.offsetX + 75;
          var top = e.domEvent.offsetY + 75;
  ...
  injectingDataToDom: function injectingDataToDom(data) {
    ...
    var numberOfContainer = total % 9 == 0 ? floor(total / 9) : Object(lodash__WEBPACK_IMPORTED_MODULE_2__["ceil"])(total / 9);
    ...
    for (var _i = 0; _i < numberOfContainer; _i++) {
      ...
      for (var j = 0; j < maxRow; j++) {
        ...
        if (j == maxRow - 1 && _i == numberOfContainer - 1) {
        ...
        for (var k = 0; k < maxInfoBox; k++) {
          ...
          var formattedHistPrice = dataArray[dataCounter].hist_price.map(function (key, value) {
            return {
              x: value,
              y: key
            };
...
}, _defineProperty(_methods, "drawMap", function drawMap() {
  var _this = this;
...
}), _defineProperty(_methods, "onMouseEnterEvent", function onMouseEnterEvent(data) {
  var infoBox = document.getElementById('map-info-box');
  var title = document.getElementById('map-info-box-title');
  var price = document.getElementById('map-info-box-price');
  var note = document.getElementById('map-info-box-note');
  ...
  infoBox.style.display = 'inline';
}), _defineProperty(_methods, "onMouseMoveEvent", function onMouseMoveEvent(e) {
  var infoBox = document.getElementById('map-info-box');
  var left = e.originalEvent.offsetX + 5;
  var top = e.originalEvent.offsetY + 5;
  infoBox.style.left = "".concat(left, "px");
  infoBox.style.top = "".concat(top, "px");
}), _defineProperty(_methods, "onMouseLeaveEvent", function onMouseLeaveEvent() {
  var infoBox = document.getElementById('map-info-box');
...
/***/ 1:
/*!******************************************************!*\
  !*** multi ./resources/js/forecourt/landing_page.js ***!
  \******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /var/www/html/laravel6/resources/js/forecourt/landing_page.js */"./resources/js/forecourt/landing_page.js");
