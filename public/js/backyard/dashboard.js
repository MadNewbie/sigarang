  ...
  generateArea: function generateArea(options) {
    options.data.forEach(function (area) {
      if (area.area != null) {
        ...
        mapsApi.event.addListener(poly, "mouseover", function (e) {
          ...
          note.innerHTML = "".concat(poly.properties.completion_percentage.toFixed(2), "%");
          infoBox.style.zIndex = 99;
          infoBox.style.display = 'inline';
        });
        mapsApi.event.addListener(poly, "mousemove", function (e) {
          var infoBox = document.getElementById('map-info-box');
        ...
        mapsApi.event.addListener(poly, "mouseout", function (e) {
          var infoBox = document.getElementById('map-info-box');
